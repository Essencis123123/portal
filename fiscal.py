...
def salvar_dados(df):
    ...
    try:
        ...
        # Converter datas para formato string para salvar no CSV
...
# ---------------------------
    ...
    if not df.empty:
        # Filtro para NFs com problema ou atrasadas
        ...
        # Top 10 fornecedores com mais juros
